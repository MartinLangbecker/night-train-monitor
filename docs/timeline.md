...
- **23.09.** Verkaufsstart und Beginn des Scrapings **ab Tag 1** — seltener Glücksfall: die volle Fill-Kurve ab Verkaufsöffnung wird erfasst (bei allen anderen Providern begann die Erhebung mitten im Verkauf, Start-Kapazität verzerrt).
  ...
  - **Quelle Pressemeldung** (Lok-Report, 23.09.2026 11:37; PM Nox Mobility): Enthüllung des ersten Waggons auf der InnoTrans + Verkaufsstart am selben Tag. Bestätigt: Start 23.03.2027, "zunächst dreimal pro Woche je Richtung" HH↔M via Bremen + Augsburg, ab 65 €. Gegründet 2025 (Thibault Constant / Janek Smalla / Artur Hasselbach), 2 Mio € Pre-Seed (IBB Ventures, 04/2026). Fernziel 100 europäische Städte bis 2035.
  - **Fahrplan gegen API verifiziert (stimmt exakt überein):** M→HH ab 21:20, Augsburg 21:51, Bremen 7:20, HH an 8:27; HH→M ab 21:22, Bremen 22:30, Augsburg 7:35, M an 8:14. Die PM-Zeiten decken sich 1:1 mit den Snapshot-Zeiten (1790/1791).
  - **Wagenmaterial / Kapazitätsdeutung** (Quelle: InnoTrans-Mock-up-Sichtung + PM, NICHT aus der API): Zum Start fahren "Nox Suites" in **1:1-Anordnung** (ein Sitz je Fensterreihe). Der gezeigte Wagen ist ein **Bpmz 294.2** (ehem. IC-2.-Klasse-Großraum, ~26,4 m Innenraum, regulär ~80 Sitze). Die beworbene **2-m-Liegefläche ist diagonal** angeordnet — die Füße liegen unter der Ablage der Nachbarsuite, wodurch der reale **Suite-Pitch nur ~1,20–1,50 m** beträgt (platzsparende Verschachtelung), nicht 2 m. Bei ~1,35 m Pitch und 1:1 auf beiden Seiten ergeben sich grob ~38 Plätze/Wagen — grobe Näherung. **`total=58` ist damit nicht eindeutig auf 1 oder 2 Wagen zurückzuführen** (1 dicht gepackter Wagen oder 2 dünnere à ~29); `total=116` ab ~14./15.04. ist in jedem Fall eine glatte Verdopplung des Startmaterials. Die genaue Suite-Dichte ist weder aus der API noch exakt aus der PM belegt — Wagenzahl bleibt eine unbestätigte Ableitung.
