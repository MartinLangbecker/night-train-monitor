...
- **23.09.** Verkaufsstart und Beginn des Scrapings **ab Tag 1** — seltener Glücksfall: die volle Fill-Kurve ab Verkaufsöffnung wird erfasst (bei allen anderen Providern begann die Erhebung mitten im Verkauf, Start-Kapazität verzerrt).
  ...
  - **Wagenmaterial / Kapazitätsdeutung** (Quelle: InnoTrans-Mock-up-Sichtung + PM, NICHT aus der API): Zum Start fahren "Nox Suites" in **1:1-Anordnung** (ein Sitz je Fensterreihe, 2 m Liegelänge in Lounge-Position). Der gezeigte Wagen ist ein **Bpmz 294.2** (ehem. IC-2.-Klasse-Großraum, regulär ~80 Sitze). Durch die 2-m-Suiten sinkt die Sitzzahl je Wagen deutlich — grob geschätzt ~20–30 Plätze. Damit ist **`total=58` zu hoch für einen einzelnen Suite-Wagen und spricht für ~2 Wagen** zum Start (≈29/Wagen); der Sprung auf `total=116` ab ~14./15.04. wäre dann eine Verdopplung auf **~4 Wagen**. Die genaue Suite-Dichte pro Wagen ist weder aus der API noch exakt aus der PM belegt — die Wagenzahl ist eine Ableitung aus 58/116 und der 1:1-Anordnung, kein bestätigter Wert.
